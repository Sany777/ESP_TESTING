...
public:
	...
	/////////////////////////////////////////////////////////////////////////////////////
        void PCD_WriteRegister(MFRC522::PCD_Register reg, uint8_t value);
        void PCD_WriteRegister(MFRC522::PCD_Register reg, uint8_t count, uint8_t *values);
        uint8_t PCD_ReadRegister(MFRC522::PCD_Register reg);
        void PCD_ReadRegister(MFRC522::PCD_Register reg, uint8_t count, uint8_t *values, uint8_t rxAlign = 0);
...
public:
	...
	virtual void PCD_WriteRegister(MFRC522::PCD_Register reg, uint8_t value) = 0;
	virtual void PCD_WriteRegister(MFRC522::PCD_Register reg, uint8_t count, uint8_t *values) = 0;
	virtual uint8_t PCD_ReadRegister(MFRC522::PCD_Register reg) = 0;
	virtual void PCD_ReadRegister(MFRC522::PCD_Register reg, uint8_t count, uint8_t *values, uint8_t rxAlign = 0);
};

// #include <Wire.h>
// class MFRC522_I2C : public MFRC522_BUS_DEVICE {
// public:
//         MFRC522_I2C(uint8_t resetPowerDownPin = UNUSED_PIN,
//                 uint8_t chipAddress = MFRC522_I2C_DEFAULT_ADDR, TwoWire & wire = Wire)
...
//         void PCD_ReadRegister(MFRC522::PCD_Register reg, uint8_t count, uint8_t *values, uint8_t rxAlign = 0);
// private:
//         uint8_t _resetPowerDownPin;        // Optional, soft-rest will be used if set to UNUSEDPIN
//         uint8_t _chipAddress;              // Default is 0x3C
...
// public:
//         MFRC522_SPI(const uint8_t chipSelectPin, const uint8_t resetPowerDownPin = UNUSED_PIN,
...
// 	uint8_t _resetPowerDownPin; // optional; software set is used when set to UNUSED_PIN.
...
public:
	MFRC522_UART(HardwareSerial &serial, uint8_t _resetPowerDownPin = UNUSED_PIN);
	bool PCD_Init();
	void PCD_WriteRegister(MFRC522::PCD_Register reg, uint8_t value);
	void PCD_WriteRegister(MFRC522::PCD_Register reg, uint8_t count, uint8_t *values);
	uint8_t PCD_ReadRegister(MFRC522::PCD_Register reg);
